...
type Reifier interface {
	...
	CreateServiceInstance(instanceID string, template string, sir *model.CreateServiceInstanceRequest) (*model.CreateServiceInstanceResponse, error)

	// CreateBinding creates a new Service Binding for a given instanceId
	CreateServiceBinding(instanceID string, sir *model.BindingRequest) (*model.CreateServiceBindingResponse, error)
