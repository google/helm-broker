...
type Controller struct {
	...
	createServiceInstance func(id string, req *brokerModel.CreateServiceInstanceRequest) (*brokerModel.CreateServiceInstanceResponse, error)
...
func (controller *Controller) CreateServiceInstance(id string, req *brokerModel.CreateServiceInstanceRequest) (*brokerModel.CreateServiceInstanceResponse, error) {
